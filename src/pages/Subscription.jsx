...
export default function Subscribe() {
	return (
		<div className="content" style={{}}>
			<main className="user-main" style={{}}>
				<h1>Join our vibrant community!</h1>
				<p>
					Unlock exclusive content, insightful perspectives, and
					valuable resources by subscribing to BlogHub.
				</p>
				...
				<section className="sub-guarantee">
					...
					<p>
						We're confident you'll love your BlogHub subscription.
						If you're not completely satisfied within the first 30
						days, simply cancel and receive a full refund.
					</p>
				</section>
			</main>
